...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($student_id > 0) {
        ...
        $query = "SELECT m.callerid, c.earning_per_admission 
                  ...
                  WHERE r.id = ? AND r.bid IN ($bids_list) AND r.coordinator_approval_status = 1
        ...
        if ($student) {
            ...
            $earning_amount = $student['earning_per_admission'] > 0 ? $student['earning_per_admission'] : 200.00;
