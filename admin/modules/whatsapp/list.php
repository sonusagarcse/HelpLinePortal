...
// Get all templates
$query = "SELECT * FROM whatsapp_templates ORDER BY id DESC";
...
<div class="wrapper">
    ...
    <div id="content">
        ...
        <div class="main-content">
            ...
            <div class="table-card shadow-sm border-0 bg-white p-3 rounded-4">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-sm">
                                            <a href="edit.php?id=<?php echo $t['id']; ?>" class="btn btn-warning" title="Edit">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <a href="delete.php?id=<?php echo $t['id']; ?>" class="btn btn-danger" 
