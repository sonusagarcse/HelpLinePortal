                  ...
                  <div class="row justify-content-center">
                     <div class="col-xl-10">
                        <div class="breadcrumb__content text-center">
                           <h3 class="breadcrumb__title">Branch Login</h3>
...
<div class="login-form">
                        <form action="code/branch_login.php" method="post">
					...
					<?php
     				...
     				if($_REQUEST['msg']=='error'){?>
		  			<strong style="color:#FF0000;">"Oops!", "Your Details Are Wrong!", "error"</strong><br/>
	  				 <?php } }?>                        
   							<label>Reg. Number / Username</label>
                                    <input type="text" class="form-control" id="regno" placeholder="Enter Your Reg. Number" name="regno" required>
                                </div>
                                <div class="form-group col-md-12"> 
