                  ...
                  <div class="row justify-content-center">
                     <div class="col-xl-10">
                        <div class="breadcrumb__content text-center">
                           <h3 class="breadcrumb__title">Health Care Login</h3>
...
<div class="login-form">
                        <form action="code/healthcare_login" method="post">
		  			...
		  			<strong style="color:#FF0000;">"Oops!", "Your Details  Are Wrong!", "error"</strong><br/>
	  				 <?php } }?>                        
   							<label>Mobile Number</label>
                                    <input type="text" class="form-control" id="Name1" placeholder="Enter Your Mobile Number" name="mob" required>
                                </div>
                                <div class="form-group col-md-12"> 
